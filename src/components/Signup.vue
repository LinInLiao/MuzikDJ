    ...
    section.mdl-cell.mdl-cell--3-col.mdl-cell--4-col-tablet.mdl-cell--12-col-phone.m-box--align-center
      form.m-signup__form
        ...
        .mdl-textfield.mdl-js-textfield.mdl-textfield--floating-label
          input#name.mdl-textfield__input.m-font__lato--thin(type="text", pattern="[a-z,A-Z,0-9 ]*", ng-model="username")
        ...
        .mdl-textfield.mdl-js-textfield.mdl-textfield--floating-label
          input#email.mdl-textfield__input.m-font__lato--thin(type="email", pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}", ng-model="email")
        ...
        .mdl-textfield.mdl-js-textfield.mdl-textfield--floating-label
          input#password.mdl-textfield__input.m-font__lato--thin(type="password", ng-model="password")
        ...
        button.mdl-button.mdl-js-button.mdl-button--raised.mdl-js-ripple-effect.m-button--full-transparent.m-font__lato--thin(type="button", ng-click="signup()") Signup
